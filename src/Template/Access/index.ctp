    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($acces->modified) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $acces->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $acces->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $acces->id], ['confirm' => __('Are you sure you want to delete # {0}?', $acces->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
