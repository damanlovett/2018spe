...
<div class="friTimeslots index large-9 medium-8 columns content">
    <h3><?= __('Fri Timeslots Candidate Interviews') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $friTimeslot->has('job') ? $this->Html->link($friTimeslot->job->title, ['controller' => 'Jobs', 'action' => 'cview', $friTimeslot->job->id]) : '' ?></td>
