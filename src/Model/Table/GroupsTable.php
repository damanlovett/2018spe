 ...
 * Groups Model
 *
 * @property \App\Model\Table\UsersoldTable|\Cake\ORM\Association\HasMany $Usersold
 * @property \App\Model\Table\Usersold3Table|\Cake\ORM\Association\HasMany $Usersold3
...
class GroupsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('Usersold', [
            'foreignKey' => 'group_id'
        ]);
        $this->hasMany('Usersold3', [
            'foreignKey' => 'group_id'
        ]);
