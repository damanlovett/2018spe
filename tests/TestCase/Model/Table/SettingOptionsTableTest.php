...
class SettingOptionsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('SettingOptions') ? [] : ['className' => SettingOptionsTable::class];
        $this->SettingOptions = TableRegistry::getTableLocator()->get('SettingOptions', $config);
    }
