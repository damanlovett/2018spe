...
class ScheduledEmailsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('ScheduledEmails') ? [] : ['className' => ScheduledEmailsTable::class];
        $this->ScheduledEmails = TableRegistry::getTableLocator()->get('ScheduledEmails', $config);
    }
