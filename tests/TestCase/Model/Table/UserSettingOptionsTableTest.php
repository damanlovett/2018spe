...
class UserSettingOptionsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('UserSettingOptions') ? [] : ['className' => UserSettingOptionsTable::class];
        $this->UserSettingOptions = TableRegistry::getTableLocator()->get('UserSettingOptions', $config);
    }
