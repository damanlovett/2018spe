...
class UserEmailTemplatesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('UserEmailTemplates') ? [] : ['className' => UserEmailTemplatesTable::class];
        $this->UserEmailTemplates = TableRegistry::getTableLocator()->get('UserEmailTemplates', $config);
    }
