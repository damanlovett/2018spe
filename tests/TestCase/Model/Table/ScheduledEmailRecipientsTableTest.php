...
class ScheduledEmailRecipientsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('ScheduledEmailRecipients') ? [] : ['className' => ScheduledEmailRecipientsTable::class];
        $this->ScheduledEmailRecipients = TableRegistry::getTableLocator()->get('ScheduledEmailRecipients', $config);
    }
