...
class UserEmailRecipientsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('UserEmailRecipients') ? [] : ['className' => UserEmailRecipientsTable::class];
        $this->UserEmailRecipients = TableRegistry::getTableLocator()->get('UserEmailRecipients', $config);
    }
