...
class LoginTokensTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('LoginTokens') ? [] : ['className' => LoginTokensTable::class];
        $this->LoginTokens = TableRegistry::getTableLocator()->get('LoginTokens', $config);
    }
