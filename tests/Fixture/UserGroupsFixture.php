...
class UserGroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'registration_allowed' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-10-31 19:26:27',
                'modified' => '2018-10-31 19:26:27'
            ],
        ];
        parent::init();
    }
