...
class UserDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'location' => ['type' => 'string', 'length' => 256, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-10-31 19:26:23',
                'modified' => '2018-10-31 19:26:23'
            ],
        ];
        parent::init();
    }
