...
class FeesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'string', 'length' => 10, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'type' => 'Lorem ip',
                'visible' => 1,
                'created' => '2018-10-31 19:26:04',
                'modified' => '2018-10-31 19:26:04'
            ],
        ];
        parent::init();
    }
