...
class JobsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'requirements' => ['type' => 'text', 'length' => 4294967295, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'employer_id' => 1,
                'user_id' => 1,
                'created' => '2018-10-31 20:13:58',
                'modified' => '2018-10-31 20:13:58'
            ],
        ];
        parent::init();
    }
